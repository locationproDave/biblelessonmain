...
const orgPlans = [
  ...
  },
  {
    ...
    monthlyPrice: 29.99,
    yearlyPrice: 324,
    monthlyPriceId: PRICE_IDS.church_monthly,
    yearlyPriceId: PRICE_IDS.church_annual,
  ...
  },
  {
    ...
    monthlyPrice: 49.99,
    yearlyPrice: 540,
    monthlyPriceId: PRICE_IDS.school_monthly,
    yearlyPriceId: PRICE_IDS.school_annual,
  ...
  },
  {
    ...
    monthlyPrice: 89.99,
    yearlyPrice: 972,
    monthlyPriceId: PRICE_IDS.org_unlimited_monthly,
    yearlyPriceId: PRICE_IDS.org_unlimited_annual,
