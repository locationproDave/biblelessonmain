...
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://restore-app-3.preview.emergentagent.com')
BACKEND_URL = os.environ.get('BACKEND_URL', 'https://restore-app-3.preview.emergentagent.com')
